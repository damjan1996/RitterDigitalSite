...
// Environment variables ohne process.env - Next.js macht diese zur Build-Zeit verfügbar
declare const NEXT_PUBLIC_GA_MEASUREMENT_ID: string | undefined;
declare const NEXT_PUBLIC_LEADINFO_ID: string | undefined;

// Environment variables - sichere Extraktion
const getEnvVar = (key: string): string | undefined => {
  switch (key) {
    case 'NEXT_PUBLIC_GA_MEASUREMENT_ID':
      return typeof NEXT_PUBLIC_GA_MEASUREMENT_ID !== 'undefined'
...
export const GA_TRACKING_ID = getEnvVar('NEXT_PUBLIC_GA_MEASUREMENT_ID');

// LeadInfo Tracking ID aus den Umgebungsvariablen
export const LEADINFO_ID = getEnvVar('NEXT_PUBLIC_LEADINFO_ID');
