...
export const Clients: React.FC<ClientsProps> = ({
  ...
  // Verwende die angegebenen Klienten oder die Standardliste
  const displayClients =
      clients.length > 0
          ? clients
          : [
            { name: 'Ritter Technologie', logo: '/images/logos/logo_rittech.png' },
            { name: 'GIS', logo: '/images/logos/logo_gis.png' },
            { name: 'LINQ IT', logo: '/images/logos/logo_linqit.png' },
            { name: 'HOMA', logo: '/images/logos/logo_homa.png' },
            { name: 'Rudolf Flume', logo: '/images/logos/logo_rudolfflumetechnik.png' }
          ];
            ...
            {displayClients.map((client, index) => (
                ...
                >
                  <div className="relative flex h-20 w-full items-center justify-center">
                    {/* Logo mit Fallback zum Firmennamen */}
                    <div className="relative h-full w-full">
                      <Image
                          ...
                          onError={(e) => {
                            // Wenn das Bild nicht geladen werden kann, zeigen wir den Namen an
