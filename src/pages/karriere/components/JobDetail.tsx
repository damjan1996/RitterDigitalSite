...
import { Briefcase, MapPin, Euro, CalendarDays, ArrowLeft, Send } from 'lucide-react';
...
export const JobDetail: React.FC<JobDetailProps> = ({ job, className, onBack }) => {
  ...
  if (!job) {
    return (
      ...
      >
        ...
        <p className="mb-6 text-[#3D5A73]">Die angeforderte Stelle konnte nicht gefunden werden.</p>
        <Button
          variant="outline"
          onClick={onBack}
  ...
  return (
    <div className={cn('relative grid grid-cols-1 gap-8 lg:grid-cols-3', className)}>
            ...
            <CardContent className="p-6">
              <div className="mb-8 grid grid-cols-2 gap-4 rounded-lg bg-[#F8F9FC] p-4 md:grid-cols-4">
                ...
                >
                  ...
                  <span className="text-sm text-[#3D5A73]">Veröffentlicht: {job.postedAt}</span>
                </motion.div>
              </div>
              ...
              <div className="prose prose-lg max-w-none text-[#3D5A73]">
                ...
                <h3 className="text-xl font-medium text-[#1A2027]">Anforderungen</h3>
                <ul className="space-y-2">
                  {job.requirements &&
                ...
                {job.benefits && job.benefits.length > 0 && (
                  <>
                    <h3 className="text-xl font-medium text-[#1A2027]">Was wir bieten</h3>
                    <ul className="space-y-2">
