...
const ContactInfo: React.FC<ContactInfoProps> = ({ icon, title, content, link }) => {
  return (
    ...
    >
      <div className="rounded-full bg-[#FF7A35]/10 p-3 text-[#FF7A35]">{icon}</div>
      <div>
        <h3 className="mb-1 font-medium text-[#1A2027]">{title}</h3>
        {link ? (
          <Link href={link} className="text-[#3D5A73] transition-colors hover:text-[#FF7A35]">
            {content}
          </Link>
        ) : (
...
export const Hero: React.FC = () => {
  ...
  return (
    <motion.section
      ref={containerRef}
      className={cn('relative flex min-h-[80vh] items-center justify-center bg-white')}
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-12 md:grid-cols-2">
            ...
            >
              ...
              >
                Wir freuen uns darauf, von Ihnen zu hören. Kontaktieren Sie uns für eine
                unverbindliche Beratung zu Ihrem Digitalisierungsprojekt.
              </motion.p>
            ...
            >
              ...
              />
              <h2 className="mb-6 text-2xl font-semibold text-[#1A2027]">Kontaktformular</h2>
              ...
              <form className="space-y-4">
                <div className="rounded-md border border-[#3D5A73]/20 p-3">
                  <label htmlFor="name" className="mb-1 block text-sm text-[#3D5A73]">
                    Name
                  </label>
                  <input
                    type="text"
                ...
                <div className="rounded-md border border-[#3D5A73]/20 p-3">
                  <label htmlFor="email" className="mb-1 block text-sm text-[#3D5A73]">
                    E-Mail
                  </label>
                  <input
                    type="email"
                ...
                <div className="rounded-md border border-[#3D5A73]/20 p-3">
                  <label htmlFor="message" className="mb-1 block text-sm text-[#3D5A73]">
                    Nachricht
                  </label>
                  <textarea
                    id="message"
