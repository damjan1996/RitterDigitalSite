    ...
    <section className={cn('relative overflow-hidden bg-primary py-20 text-white')}>
      <div className="container relative z-10 mx-auto px-4">
        <div className="max-w-3xl">
          <h1 className="mb-4 text-4xl font-bold md:text-5xl">Sprechen Sie mit uns</h1>
          <p className="max-w-2xl text-xl opacity-90">
            Wir freuen uns darauf, von Ihnen zu hören. Kontaktieren Sie uns für eine unverbindliche
            Beratung zu Ihrem Digitalisierungsprojekt.
          </p>
        </div>
      </div>
