        ...
        features: [
            {
                ...
                description: "Moderne, skalierbare und benutzerfreundliche Webanwendungen mit React, Next.js und anderen führenden Technologien.",
                icon: "LayoutDashboard"
            },
            {
                title: "Backend-Systeme",
                description: "Leistungsstarke und zuverlässige Backend-Lösungen mit Node.js, .NET oder Java, je nach Ihren Anforderungen.",
                icon: "Database"
            },
            {
                title: "API-Entwicklung",
                description: "RESTful und GraphQL APIs für nahtlose Integration zwischen verschiedenen Systemen und Diensten.",
                icon: "Link"
            },
            {
                title: "Datenbanklösungen",
                description: "Optimierte Datenbankstrukturen mit SQL und NoSQL-Technologien für effiziente Datenspeicherung und -abfrage.",
                icon: "BarChart"
            }
        ],
        benefits: [
            {
                ...
                description: "Software, die exakt auf Ihre Geschäftsprozesse zugeschnitten ist, ohne Kompromisse bei Funktionalität oder Benutzerfreundlichkeit."
            },
            {
                title: "Skalierbarkeit",
                description: "Lösungen, die mit Ihrem Unternehmen mitwachsen und bei Bedarf einfach erweitert werden können."
            },
            {
                title: "Kosteneffizienz",
                description: "Reduzierte Kosten durch automatisierte Prozesse und eliminierte manuelle Arbeitsschritte."
            },
            {
                title: "Wettbewerbsvorteil",
                description: "Maßgeschneiderte Software, die Ihren spezifischen Bedürfnissen entspricht und Ihnen einen Vorsprung vor der Konkurrenz verschafft."
            }
        ],
        videoSrc: "https://www.youtube.com/embed/HjCoZNrzA5Q",
        ctaText: "Ihre Software-Idee verwirklichen?",
        ctaDescription: "Kontaktieren Sie uns für ein unverbindliches Beratungsgespräch über Ihr Softwareprojekt."
    };
    ...
    return (
        <>
            ...
            <div>
                ...
                >
                    <div className="mt-8">
                        <h3 className="text-xl font-semibold text-primary mb-4">Unser Entwicklungsprozess:</h3>
                        <ol className="space-y-4 text-secondary">
                            <li className="flex items-start">
                                <div className="mr-3 font-bold">1.</div>
                                <span><strong className="text-primary">Anforderungsanalyse:</strong> Wir analysieren gemeinsam mit Ihnen Ihre spezifischen Anforderungen und Geschäftsprozesse.</span>
                            </li>
                            <li className="flex items-start">
                                <div className="mr-3 font-bold">2.</div>
                                <span><strong className="text-primary">Konzeption & Design:</strong> Wir erstellen ein detailliertes Konzept und Wireframes für Ihre Softwarelösung.</span>
                            </li>
                            <li className="flex items-start">
                                <div className="mr-3 font-bold">3.</div>
                                <span><strong className="text-primary">Entwicklung:</strong> Agile Entwicklung mit regelmäßigen Feedbackschleifen und Iterationen.</span>
                            </li>
                            <li className="flex items-start">
                                <div className="mr-3 font-bold">4.</div>
                                <span><strong className="text-primary">Testing & Qualitätssicherung:</strong> Umfangreiche Tests zur Sicherstellung höchster Qualität.</span>
                            </li>
                            <li className="flex items-start">
                                <div className="mr-3 font-bold">5.</div>
                                <span><strong className="text-primary">Einführung & Schulung:</strong> Reibungslose Implementierung und Schulung Ihrer Mitarbeiter.</span>
                            </li>
                            <li className="flex items-start">
                                <div className="mr-3 font-bold">6.</div>
                                <span><strong className="text-primary">Wartung & Support:</strong> Kontinuierliche Betreuung und Weiterentwicklung Ihrer Software.</span>
                            </li>
                        </ol>
                    </div>
                </ServiceDetails>
                ...
                <section className="py-16 bg-background">
                    <div className="container mx-auto px-4">
                        <h2 className="text-3xl font-bold text-primary mb-12 text-center">Unsere Technologien</h2>

                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 max-w-4xl mx-auto">
                            {technologies.map((tech, index) => (
                                <div key={index} className="flex flex-col items-center justify-center bg-white p-6 rounded-lg shadow-sm">
