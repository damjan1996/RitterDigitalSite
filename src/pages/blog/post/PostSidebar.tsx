        ...
        <div className={cn("space-y-6", className)}>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="flex flex-col items-center text-center">
                            ...
                            {author.position && (
                                <p className="text-sm text-tertiary mt-1">{author.position}</p>
                            )}

                            {author.bio && (
                                <p className="text-sm text-secondary mt-3">{author.bio}</p>
                            )}
                        </div>
                    </CardContent>
                </Card>
                            ...
                            {tags.map((tag) => (
                                ...
                                >
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="bg-gray-100 hover:bg-gray-200 text-secondary"
                                    >
                                        {tag}
                                    </Button>
                                </Link>
            ...
            <Card className="bg-accent text-white">
                <CardContent className="pt-6">
                    <h3 className="text-lg font-semibold mb-2">Benötigen Sie Unterstützung?</h3>
