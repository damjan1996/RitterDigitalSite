        ...
        <Container>
          <div className="mx-auto max-w-3xl">
            ...
            <div className="prose prose-lg max-w-none rounded-lg bg-white p-8 shadow-sm">
              ...
              <p>
                <strong>Ritter Digital GmbH</strong>
                <br />
                Musterstraße 123
                <br />
                12345 Musterstadt
              ...
              <p>
                ...
                oder bei einer Kontaktaufnahme mit uns (z.B. per Kontaktformular oder E-Mail)
                freiwillig mitteilen. Welche Daten erhoben werden, ist aus den jeweiligen
                Eingabeformularen ersichtlich. Wir verwenden die von Ihnen mitgeteilten Daten zur
                Vertragsabwicklung und zur Bearbeitung Ihrer Anfragen.
              </p>

              <h2>3. Cookies und Webanalyse</h2>
              <p>
                Unsere Website verwendet Cookies. Bei Cookies handelt es sich um kleine Textdateien,
                die auf Ihrem Endgerät gespeichert werden und die bestimmte Einstellungen und Daten
                zum Austausch mit unserem System über Ihren Browser speichern.
              </p>
              <p>
                Wir verwenden sowohl technisch notwendige Cookies, ohne die die Funktionalität
                unserer Website eingeschränkt wäre, als auch optionale Cookies zu Analyse- und
                Marketingzwecken. Sie können Ihre Einwilligung zur Verwendung optionaler Cookies
                jederzeit über unser Cookie-Banner anpassen.
              </p>
              ...
              <p>
                ...
                des Abkommens über den Europäischen Wirtschaftsraum zuvor gekürzt wird. Nur in
              ...
              <p>
                Wir verwenden für den Versand unseres Newsletters das Verfahren des Double-Opt-In,
                d.h. wir werden Ihnen erst dann Newsletter zusenden, wenn Sie Ihre Anmeldung über
                eine Ihnen zu diesem Zweck zugesandte Bestätigungs-E-Mail per darin enthaltenem Link
                bestätigen.
              </p>
              <p>
                Ihre Einwilligung zum Empfang des Newsletters können Sie jederzeit widerrufen und
                somit das Newsletter-Abonnement kündigen. Den Widerruf können Sie durch Klick auf
                den in jeder Newsletter-E-Mail bereitgestellten Link oder durch eine Nachricht an
                die oben angegebenen Kontaktdaten erklären.
              </p>
              ...
              <p>
                ...
                Datenschutzerklärung kann jederzeit auf dieser Website von Ihnen abgerufen werden.
              </p>
            </div>
          </div>
        </Container>
