...
const tabsTriggerVariants = cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50",
    {
        variants: {
            variant: {
                default: "data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-sm",
                underlined: "border-b-2 border-transparent px-1 pb-3 data-[state=active]:border-accent data-[state=active]:text-accent",
                pills: "rounded-full px-3 py-1.5 text-secondary data-[state=active]:bg-accent data-[state=active]:text-white",
                cards: "rounded-md border border-transparent px-4 py-2 hover:bg-gray-50 data-[state=active]:border-gray-200 data-[state=active]:bg-white data-[state=active]:text-primary data-[state=active]:shadow-sm",
            },
            fullWidth: {
                true: "flex-1",
                false: "",
