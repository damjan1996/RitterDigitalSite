        ...
        >
          ...
          <motion.div className='max-w-3xl' variants={containerVariants}>
            ...
            <motion.p
              ...
              className='mb-6 text-xl text-[#3D5A73]'
            >
              Ihr Partner für digitale Optimierung von Prozessen und
              maßgeschneiderte Softwarelösungen
            </motion.p>

            <motion.p
              variants={itemVariants}
              className='text-lg text-[#3D5A73]/80'
            >
              Seit über 20 Jahren unterstützen wir Unternehmen bei der
              Digitalisierung ihrer Geschäftsprozesse und entwickeln
              individuelle Lösungen, die echten Mehrwert schaffen. Mit über 90
              zufriedenen Kunden und einem Team aus erfahrenen Experten setzen
              wir auf langfristige Partnerschaften und nachhaltige Erfolge.
            </motion.p>
