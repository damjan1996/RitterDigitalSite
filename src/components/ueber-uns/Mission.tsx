      ...
      <Container className='relative z-10 max-w-6xl'>
        <div className='grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16'>
          ...
          >
            ...
            <motion.p
              className='mb-6 text-lg text-[#3D5A73]'
              variants={itemVariants}
            >
              Bei Ritter Digital haben wir es uns zur Aufgabe gemacht,
              Unternehmen durch maßgeschneiderte digitale Lösungen zu stärken
              und ihnen zu nachhaltigem Wachstum zu verhelfen.
            </motion.p>

            <motion.div variants={itemVariants} className='mb-8'>
              <h3 className='mb-4 text-xl font-medium text-[#1A2027]'>
                Wir glauben an:
              </h3>
            ...
            >
              <p className='text-lg italic text-[#3D5A73]'>
                &#34;Wir streben danach, der verlässlichste Partner für die
                digitale Transformation zu sein und unseren Kunden durch
                innovative Technologien einen echten Wettbewerbsvorteil zu
                verschaffen.&#34;
              </p>
            </motion.div>
