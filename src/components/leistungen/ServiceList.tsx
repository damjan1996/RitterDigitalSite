...
const services = [
    ...
    useCases: [
      {
        ...
        description:
          'Digitalisierung und Automatisierung von manuellen Arbeitsprozessen',
      },
      {
        title: 'Wissensmanagement',
        description:
          'Implementierung digitaler Systeme für effizientes Wissensmanagement',
      },
      {
        title: 'Digitale Transformation',
        description:
          'Umfassende Strategie zur digitalen Transformation des Unternehmens',
      },
    ],
    caseStudy: {
    ...
    useCases: [
      {
        ...
        description:
          'Echtzeit-Überwachung von Verkaufskennzahlen und Kundenverhalten',
      },
      {
        title: 'Logistikoptimierung',
        description:
          'Analyse von Lieferzeiten und Identifikation von Prozessengpässen',
      },
      {
        title: 'Finanzreporting',
        description:
          'Automatisierte Erstellung von monatlichen Finanzberichten',
      },
    ],
    caseStudy: {
  ...
  },
  {
    ...
    useCases: [
      ...
      },
      {
        title: 'Customer 360',
        description:
          'Ganzheitliche Kundensicht durch Integration aller Datenquellen',
      },
      {
  ...
  },
  {
    ...
    useCases: [
      {
        ...
        description:
          'Digitalisierung und Optimierung manueller Geschäftsprozesse',
      },
      {
        title: 'E-Commerce-Plattformen',
        description:
          'Entwicklung skalierbarer Onlineshop-Lösungen mit ERP-Anbindung',
      },
      {
        title: 'Interne Tools',
    ...
    caseStudy: {
      ...
      result:
        'Reduzierung der Auftragsbearbeitungszeit um 60% durch automatisierte Prozesse',
      description:
    ...
    useCases: [
      {
        ...
        description:
          'KI-basierte Analyse von Kundenverhalten für gezielte Marketingmaßnahmen',
      },
      {
        title: 'Dokumentenanalyse',
        description:
          'Automatische Extraktion relevanter Informationen aus Dokumenten',
      },
      {
        title: 'Absatzprognosen',
        description:
          'Präzise Vorhersagen von Absatzzahlen für optimierte Bestandsplanung',
      },
    ],
    caseStudy: {
      title: 'Online-Händler',
      result:
        '30% höhere Conversion-Rate durch KI-basierte Produktempfehlungen',
      description:
  ...
  },
  {
    ...
    useCases: [
      {
        ...
        description:
          'Anbindung von Online-Shops an das zentrale Warenwirtschaftssystem',
      },
      {
    ...
    caseStudy: {
      title: 'Online-Händler',
      result:
        '50% Zeitersparnis bei der Auftragsbearbeitung durch optimierte JTL-Prozesse',
      description:
        ...
        >
          <motion.div className='mb-16 text-center' variants={titleVariants}>
            ...
            <p className='mx-auto mt-4 max-w-2xl text-[#3D5A73]/80'>
              Entdecken Sie unser umfassendes Angebot an digitalen Lösungen für
              Ihr Unternehmen. Von der Datenanalyse bis zur Software-Entwicklung
              bieten wir maßgeschneiderte Dienste für Ihre individuellen
              Anforderungen.
            </p>
          </motion.div>
    ...
    >
      ...
      >
        ...
        <div className='relative h-64 w-full md:w-2/5'>
          ...
          {service.videoUrl ? (
            ...
            <Image
              src={
                service.imageUrl ||
                '/placeholder.svg?height=400&width=600&query=digital+technology'
              }
              alt={service.title}
              fill
        ...
        <div className='flex flex-1 flex-col p-6 md:p-8'>
          ...
          {/* Technologies */}
          <div className='mb-6'>
            <p className='mb-2 text-sm font-medium text-[#1A2027]'>
          ...
          >
            <div className='border-t border-gray-100 p-8'>
              <div className='grid gap-8 md:grid-cols-2'>
                {/* Left column */}
                <div>
                  <h4 className='mb-4 text-lg font-medium text-[#1A2027]'>
                    Ihre Vorteile
                  </h4>
                  ...
                  <div className='mt-8'>
                    ...
                    <div className='space-y-3'>
                      {service.useCases.map((useCase, idx) => (
                        ...
                        >
                          <h5 className='font-medium text-[#1A2027]'>
                            {useCase.title}
                          </h5>
