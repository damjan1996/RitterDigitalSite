        ...
        <div className='grid grid-cols-1 gap-8 md:grid-cols-2'>
          <div>
            ...
            <p className='mb-6 text-gray-600'>
              Entdecken Sie unsere innovativen Lösungen für Ihr Unternehmen. Wir
              bieten maßgeschneiderte Services, die genau auf Ihre Anforderungen
              zugeschnitten sind.
            </p>
            ...
            {item.submenu.slice(0, 4).map(subItem => (
              ...
              >
                ...
                <div className='absolute inset-0 flex items-end bg-gradient-to-t from-black/70 to-transparent'>
                  <span className='p-3 font-medium text-white'>
                    {subItem.title}
                  </span>
                </div>
              </div>
