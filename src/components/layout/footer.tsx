      ...
      <Container className='relative z-10'>
        ...
        >
          ...
          <motion.div className='lg:col-span-4' variants={itemVariants}>
            ...
            <motion.p
              className='mb-8 max-w-xs text-[#3D5A73]'
              variants={itemVariants}
            >
              Dive into a world where technology and digital solutions converge
              to create mind-blowing experiences for your business.
            </motion.p>
          ...
          <motion.div className='lg:col-span-3' variants={itemVariants}>
            ...
            <div className='space-y-6'>
              <motion.div
                ...
                transition={{ duration: 0.2 }}
              >
                <span className='mb-1 text-sm font-medium text-[#3D5A73]'>
                  Email
                </span>
                <a
        ...
        >
          <motion.p
            ...
            transition={{ duration: 0.2 }}
          >
            © {currentYear} RITTER Gesellschaft für digitale Geschäftsprozesse
