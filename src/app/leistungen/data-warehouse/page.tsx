// src/app/leistungen/data-warehouse/page.tsx
...
export const metadata: Metadata = {
  title: 'Data Warehouse | Ritter Digital GmbH',
  description:
    'Data Warehouse Lösungen von Ritter Digital - Zentralisieren und optimieren Sie Ihre Unternehmensdaten für bessere Business Intelligence und datengetriebene Entscheidungen.',
  keywords: [
    'Data Warehouse',
    'Datenlager',
    'ETL',
  ...
  alternates: {
    canonical: '/leistungen/data-warehouse',
  },
};
...
export default function DataWarehousePage() {
    ...
    benefits: [
      {
        ...
        description:
          'Single Point of Truth für alle Unternehmensdaten und -berichte.',
      },
      {
        title: 'Verbesserte Datenqualität',
        description:
          'Durch automatisierte Bereinigungs- und Validierungsprozesse.',
      },
      {
        title: 'Schnellere Analysen',
        description:
          'Optimierte Datenstrukturen für performante Abfragen und Berichte.',
      },
      {
  ...
  return (
    <div>
        ...
        <div className='mt-8'>
          ...
          <ul className='space-y-2 text-secondary'>
            <li className='flex items-start'>
              ...
              <span>
                Konzeption und Implementierung neuer Data Warehouse-Systeme
              </span>
            </li>
            <li className='flex items-start'>
              <div className='mr-2 text-accent'>•</div>
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='rounded-lg bg-white p-6 shadow-sm'>
            ...
            <p className='mt-4 text-center text-secondary'>
              Typische Architektur eines modernen Data Warehouse Systems mit
              ETL-Prozessen und Business Intelligence-Anbindung
            </p>
          </div>
        </div>
      </section>
      ...
      />
      <ServiceBenefits
        title='Vorteile eines Data Warehouse'
