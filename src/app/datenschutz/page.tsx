    ...
    },
    {
      ...
      content: (
        <p className='text-[#3D5A73]'>
          ...
          Kontaktformular oder E-Mail) freiwillig mitteilen. Welche Daten
      ...
      content: (
        <>
          <p className='mb-4 text-[#3D5A73]'>
            ...
            kleine Textdateien, die auf Ihrem Endgerät gespeichert werden und
          ...
          <p className='mb-6 text-[#3D5A73]'>
            Wir verwenden sowohl technisch notwendige Cookies, ohne die die
            Funktionalität unserer Website eingeschränkt wäre, als auch
            optionale Cookies zu Analyse- und Marketingzwecken. Sie können Ihre
            Einwilligung zur Verwendung optionaler Cookies jederzeit über unser
            Cookie-Banner anpassen.
          </p>

          <div className='mb-6 space-y-6'>
            <div className='rounded-lg border border-[#3D5A73]/10 p-5'>
              <h3 className='mb-3 text-lg font-medium text-[#1A2027]'>
              ...
              <p className='mb-3 text-[#3D5A73]'>
                ...
                Verantwortlicher für die Datenverarbeitung ist die Google
            ...
            <div className='rounded-lg border border-[#3D5A73]/10 p-5'>
              ...
              <p className='text-[#3D5A73]'>
                ...
                (Hannover, Deutschland) Daten zu Marketing- und
                ...
                Hierzu können Cookies eingesetzt werden, die jedoch
                ausschließlich mit Ihrer Einwilligung gesetzt werden.
              </p>
            </div>
          </div>
        </>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className='text-[#3D5A73]'>
            Für die Verarbeitung Ihrer Daten im Rahmen des Kontaktformulars
            holen wir Ihre Einwilligung ein und verweisen dazu auf diese
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p className='mb-4 text-[#3D5A73]'>
            Wir verwenden für den Versand unseres Newsletters das Verfahren des
            Double-Opt-In, d.h. wir werden Ihnen erst dann Newsletter zusenden,
          ...
          <p className='text-[#3D5A73]'>
            Ihre Einwilligung zum Empfang des Newsletters können Sie jederzeit
            widerrufen und somit das Newsletter-Abonnement kündigen. Den
            Widerruf können Sie durch Klick auf den in jeder Newsletter-E-Mail
            bereitgestellten Link oder durch eine Nachricht an die oben
      ...
      content: (
        <>
          ...
          <p className='text-[#3D5A73]'>
            ...
            dieser Website von Ihnen abgerufen werden.
          </p>
        </>
      ),
    },
          ...
          <div className='mx-auto max-w-5xl'>
            ...
            <div className='mb-8'>
              <div className='mb-2'>
                <Link
                  href='/public'
                  className='flex items-center gap-2 text-sm text-[#3D5A73]'
                >
                  ...
                  {sections.map(section => (
                    ...
                    >
                      <div className='mb-4 flex items-start gap-2'>
                        ...
                        <h2 className='text-xl font-medium text-[#1A2027]'>
                          {section.title}
                        </h2>
                      </div>
